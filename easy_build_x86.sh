...
$script_dir/scripts/checkBuildSystemNoInteractive.pl i686-pedigree $COMPILER_DIR $compiler_build_options
...
cmake -DCMAKE_TOOLCHAIN_FILE=../build-etc/cmake/pedigree_i686.cmake -DIMPORT_EXECUTABLES=../build-host/HostUtilities.cmake $TRAVIS_OPTIONS ..
...
# What a mess!
$script_dir/scripts/checkBuildSystemNoInteractive.pl i686-pedigree $COMPILER_DIR $compiler_build_options "libcpp"
