...
set(PEDIGREE_C_COMPILER ${CMAKE_SOURCE_DIR}/compilers/dir/bin/i686-pedigree-gcc)
set(PEDIGREE_CXX_COMPILER ${CMAKE_SOURCE_DIR}/compilers/dir/bin/i686-pedigree-g++)
...
if (${CMAKE_VERSION} VERSION_LESS 3.6.0)
    ...
    set(CMAKE_OBJCOPY ${CMAKE_SOURCE_DIR}/compilers/dir/bin/i686-pedigree-objcopy)
    set(CMAKE_STRIP ${CMAKE_SOURCE_DIR}/compilers/dir/bin/i686-pedigree-strip)
else ()
...
set(CMAKE_SYSROOT "${CMAKE_SOURCE_DIR}/compilers/dir/i686-pedigree")

set(CMAKE_FIND_ROOT_PATH ${CMAKE_SOURCE_DIR}/compilers/dir ${CMAKE_SOURCE_DIR}/compilers/dir/bin ${CMAKE_SOURCE_DIR}/compilers/dir/i686-pedigree)
...
set(PEDIGREE_COMPILER_TARGET i686-pedigree)
set(PEDIGREE_ARCH_TARGET X86)
set(PEDIGREE_LINKERSCRIPT "${CMAKE_SOURCE_DIR}/src/system/kernel/core/processor/x86/kernel.ld")
set(PEDIGREE_ARCHDIR "x86")
set(PEDIGREE_MACHDIR "mach_pc")
set(PEDIGREE_LINKERDIR "x86")
set(PEDIGREE_DRIVERDIR "x86")
# TODO: normalize on this so the number of definitions above can be reduced
set(PEDIGREE_ASMDIR "x86")
set(PEDIGREE_MUSLARCH "i686")
...
# Definitions for i686 across the entire source tree.
add_definitions(-DX86_COMMON=1 -DX64=0 -DMACH_PC=1 -DBITS_64=0 -DBITS_32=1
